...
describe('Header of the entire app', () => {
    ...
    it('Clicking download button makes download menu appear', () => {
        const wrapper = mount(Header, { localVue, store, stubs })
        expect(wrapper.findComponent({ name: 'downloadDesktop'} ).exists()).toBeFalsy()
        const downloadButton = wrapper.find("#buttonDownload")
